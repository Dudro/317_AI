...
localbeam_gen = local_beam_search(GraphState(2, 0, [2]), at_bucharest, trans_op, f,5)
for solution,_ in localbeam_gen:
    print(str(solution.get_cost_so_far()) + " " + str(solution.get_path_so_far()))
